            ...
            schema: [
                {
                    ...
                    action: entityConfig.actions && entityConfig.actions.map(function (a) {
                        var def = {
                            name: a.name,
                            isBound: undefined,
                            parameter: undefined,
                    ...
                    function: entityConfig.functions && entityConfig.functions.map(function (a) {
                        var def = {
                            name: a.name,
                            isBound: undefined,
                            parameter: undefined,
                    ...
                    entityContainer: {
                        ...
                        actionImport: entityConfig.actions && entityConfig.actions.filter(function (a) { return !a.isBound; }).map(function (a) {
                            var def = {
                                name: a.name,
                        ...
                        functionImport: entityConfig.functions && entityConfig.functions.filter(function (a) { return !a.isBound; }).map(function (a) {
                            var def = {
                                name: a.name,
